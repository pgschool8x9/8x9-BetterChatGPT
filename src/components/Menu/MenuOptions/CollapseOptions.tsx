...
const CollapseOptions = () => {
  ...
  return (
    <div
      className={`fill-black dark:fill-white hover:bg-gray-900/10 dark:hover:bg-gray-500/10 transition-colors duration-200 px-3 rounded-md cursor-pointer flex justify-center`}
