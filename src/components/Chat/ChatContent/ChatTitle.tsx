      ...
      <div className='sticky top-0 z-10 flex items-center justify-between w-full bg-white/40 dark:bg-gray-900/40 backdrop-blur-md px-2 md:px-4 py-3 md:py-3 text-gray-600 dark:text-gray-300'>
        ...
        <div className='flex items-center gap-1 md:gap-2'>
          ...
          <div className='relative' ref={downloadRef}>
            ...
            {/* ダウンロードドロップダウン */}
            {isDownloadOpen && (
              <div className='absolute right-0 mt-6 w-48 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md rounded-lg shadow-[0_0_10px_rgba(0,0,0,0.10)] dark:shadow-[0_0_15px_rgba(0,0,0,0.10)] border border-black/10 dark:border-white/10 z-50'>
                <div className='p-2'>
                  <button
...
{t('image')}
          ...
          <div className='relative' ref={configRef}>
            ...
            {/* コンパクトな設定ポップアップ */}
            {isConfigExpanded && (
              <div className='absolute right-0 mt-6 w-80 max-w-[calc(100vw-2rem)] bg-white/80 dark:bg-gray-900/80 backdrop-blur-md rounded-lg shadow-[0_0_10px_rgba(0,0,0,0.10)] dark:shadow-[0_0_15px_rgba(0,0,0,0.10)] border border-black/10 dark:border-white/10 z-50 max-h-96 overflow-y-auto'>
